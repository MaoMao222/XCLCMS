    ...
    public class LogicFileController : BaseController
    {
        ...
        public ActionResult List()
        {
            ...
            viewModel.Search.TypeList = new List<XCLNetSearch.SearchFieldInfo>() {
                ...
                new XCLNetSearch.SearchFieldInfo("查看类型","ViewType|string|select",XCLNetTools.Control.HtmlControl.Lib.GetOptions(typeof(XCLCMS.Data.CommonHelper.EnumType.AttachmentViewTypeEnum))),
                new XCLNetSearch.SearchFieldInfo("格式类型","FormatType|string|select",XCLNetTools.Control.HtmlControl.Lib.GetOptions(typeof(XCLCMS.Data.CommonHelper.EnumType.AttachmentFormatTypeEnum))),
